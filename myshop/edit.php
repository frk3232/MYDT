...
if($_SERVER['REQUEST_METHOD']=='GET'){
    ...
    do{
        if(empty($id)||empty($Emp_Name)||empty($Salary)||empty($Department)||empty($Age)) {
            $errorMessage="All the fields are required";
            break;
        }

        $sql="UPDATE employee " .
             "SET Emp_Name='$Emp_Name', Salary='$Salary', Department='$Department', Age='$Age' " .
             "WHERE id=$id";
        ...
        $successMessage="The employee updated successfully";
